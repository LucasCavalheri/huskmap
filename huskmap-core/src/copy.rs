...
pub struct Deck {
    ...
    pub filters_more: &'static str,
    pub filters_less: &'static str,
...
pub const EN: Deck = Deck {
    ...
    update_no_pkexec: "Installing a package needs pkexec (polkit). Or run: curl -fsSL https://huskmap.lucascavalheri.com.br/install.sh | bash",
...
pub const PT_BR: Deck = Deck {
    ...
    update_no_pkexec: "Instalar o pacote precisa do pkexec (polkit). Ou rode: curl -fsSL https://huskmap.lucascavalheri.com.br/install.sh | bash",
